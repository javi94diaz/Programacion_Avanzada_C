// Practica de ordenacion y recursividad
...
int main(void) {
	...
	// Preguntamos al usuario la dimension deseada
	while(dim <= 0)
	{
	...
	// Vemos vectores originales (descomentar para vectores con pocos elementos)
	//imprime(vect, dim);
	//imprime(vect2, dim);
	...
	printf("Tiempo sort iterativo con %d elementos: %f seg\n",dim, etime1); 
	...
	// Vemos los vectores ordenados (descomentar para vectores con pocos elementos)
	//imprime(vect, dim);
	//imprime(vect2, dim);
