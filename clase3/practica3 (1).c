...
/*
Practica3 - Javier Diaz Mena - 12100
Basándose en los programas de ejemplo proporcionados, y en la practica anterior,
escribir otro para que se cree una cola de mensajes para comunicación entre un
...
int main(void)
{
		...
		case 0:
			...
			while(respuesta != 3) {
				...
				if (intentoTrad > numSecreto){
					...
					printf("Hijo: Correcto! Has adivinado el numero secreto\n");
					respuesta = 3;
				}
	...
	while (respuestaTrad != 3){
		...
		// Lectura de la respuesta del hijo de tipo 2
